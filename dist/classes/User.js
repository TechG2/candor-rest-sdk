        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, axios_1.default.get("".concat(config_1.default.getBaseUrl(), "/reviews/freelancer/").concat(this.freelancerId), {
                                headers: {
                    ...
                    case 2:
                        response = _a.sent();
                        data = response.data;
                        reviews = data.map(function (result) { return new Review_1.default(result, _this.candorAPI); });
                        if (config_1.default.enableCache)
                            this.candorAPI.cache.reviews.set(this.freelancerId, reviews);
                        return [2 /*return*/, reviews];
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("There has been an error during the fetch: " + error_1);
